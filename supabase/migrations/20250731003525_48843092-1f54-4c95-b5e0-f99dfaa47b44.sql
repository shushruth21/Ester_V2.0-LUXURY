...
INSERT INTO public.attribute_types (name, display_name, input_type, is_required, sort_order)
VALUES 
  ('overall_length', 'Overall Length', 'input', false, 12),
  ('overall_width', 'Overall Width', 'input', false, 13),
  ('overall_height', 'Overall Height', 'input', false, 14)
